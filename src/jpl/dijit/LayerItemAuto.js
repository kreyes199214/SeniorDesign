define([
    ...
    'dojo/text!./templates/LayerItemAuto.html',
    "jpl/config/Config",
    "jpl/data/Layers",
    ...
    return declare([_WidgetBase, _TemplatedMixin], {
            ...
            setListeners: function(){
                ...
                topic.subscribe(LayerEvent.prototype.TOGGLE_AUTO_LAYER_VISIBILITY, lang.hitch(this, this.toggleAutoLayerVisibility));
                ...
                topic.subscribe(LayerEvent.prototype.REMOVE_FROM_AUTO_LAYERS, lang.hitch(this, this.removeFromAutoLayers));
                this.opacityListener = topic.subscribe(LayerEvent.prototype.CHANGE_OPACITY, lang.hitch(this, this.changeLayerOpacity));
            },

            toggleAutoLayerVisibility: function(evt){
            ...
            removeFromAutoLayers: function(evt){
                var evtProjection = this.getProjectionFromMap(evt.map);
                if(evt.productLabel === this.layer.productLabel &&
                    evtProjection === this.layer.layerProjection){
                    this.opacityListener.remove();
                    this.destroy();
                }
            },
            ...
            changeLayerOpacity: function(evt) {
                if(evt.layer.productLabel === this.mapLayer.id) {
                    console.log("CHANGE OPAC sliderWidget", this.sliderWidget);
            ...
            getProjectionFromMap: function(map){
                var projection;

                if(map === this.mapDijit.equirectMap){
                    projection = this.config.data.projections.equirect;
                }else if(map === this.mapDijit.northPoleMap){
                    projection = this.config.data.projections.northpole;
                }else if(map === this.mapDijit.southPoleMap){
                    projection = this.config.data.projections.southpole;
                }
