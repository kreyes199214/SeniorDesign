define([
    ...
    /**
     * Utility class to create a Singleton. Adds a getInstance() method and destroys the constructor after first
     * instance is created.
     * @requires dojo/_base/lang
     * @class jpl.utils.MakeSingletonUtil
     */
    return function(ctor) {   // not defining a class, just a utility method.
        ...
        singletonCtor = new function(arg) {       // note: 'new' is important here!!
            this.getInstance = function(arg) {    // our accessor function
                if (!instance) {               // captures instance in a closure
                    instance = new ctor(arg);       // create instance using original ctor.
