    ...
    return declare(null, {
        ...
        getSteps: function() {
            ...
            if(this.config.controls.search){
                ...
                step = {
                    element: "#controlItemSearch",
                    title: textContent.HelpGallery_interactiveTour_controlItemSubFacetSelectBookmarkTitle,
                    content: textContent.HelpGallery_interactiveTour_controlItemSubFacetSelectBookmarkContent,
                    placement: "right",
                    selectedOption:"subFacetSelectBookmark"
                };
                steps.push(step);
                step = {
                    element: "#controlItemSearch",
                    title: textContent.HelpGallery_interactiveTour_controlItemSubFacetSelectProductTitle,
                    content: textContent.HelpGallery_interactiveTour_controlItemSubFacetSelectProductContent,
                    placement: "right",
                    selectedOption:"subFacetSelectProduct"
                };
                steps.push(step);
                step = {
                    element: "#controlItemSearch",
                    title: textContent.HelpGallery_interactiveTour_controlItemSubFacetSelectNomenclatureTitle,
                    content: textContent.HelpGallery_interactiveTour_controlItemSubFacetSelectNomenclatureContent,
                    placement: "right",
                    selectedOption:"subFacetSelectNomenclature"
                };
                steps.push(step);
                step = {
                    element: "#controlItemSearch",
            ...
            steps.push(
                {
                    ...
                    "<button class='btn btn-success' data-role='end' style='float:none;'>Explore Mars!</button></div>" +
                    "</div></div>",
        ...
        displaySidebar: function(step, currentStepId, show) {
            ...
            switch(selectedOption){
                ...
                case "searchSubfacet":
                    ...
                    break;
                case "subFacetSelectBookmark":
                    this.sendAllToBack();
                    this.closeSearchSidebarViewers();
                    this.bringSelectorToFront('#searchSidebarSearchBarResults ul [data-id=0]');
                    break;
                case "subFacetSelectProduct":
                    this.sendAllToBack();
                    this.closeSearchSidebarViewers();
                    this.bringSelectorToFront('#searchSidebarSearchBarResults ul [data-id=1]');
                    break;
                case "subFacetSelectNomenclature":
                    this.sendAllToBack();
                    this.closeSearchSidebarViewers();
                    this.bringSelectorToFront('#searchSidebarSearchBarResults ul [data-id=3]');
                    break;
                case "searchViewerSelect":
                    this.controlBar.closeSidebars();
                    this.controlBar.activateSearch();
                    this.sendAllToBack();
                    this.selectSearchItem("searchSidebarSearchBarResults", 1);
                    break;
                case "highlightTools":
                    this.sendAllToBack();
                    this.controlBar.closeSidebars();
        ...
        sendAllToBack: function(){
            ...
            div = query('#searchSidebarSearchBarResults ul [data-id=0]')[0];
            if(div){
                domClass.remove(div, "helpZIndexFront");
            }
            div = query('#searchSidebarSearchBarResults ul [data-id=1]')[0];
            if(div){
                domClass.remove(div, "helpZIndexFront");
            }
            div = query('#searchSidebarSearchBarResults ul [data-id=3]')[0];
            if(div){
                domClass.remove(div, "helpZIndexFront");
            }
        },
        ...
        bringSelectorToFront: function(cssSelector){
            var div = query(cssSelector)[0];
            domClass.add(div, "helpZIndexFront");
        },
